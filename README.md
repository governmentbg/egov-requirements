...
1.  **Цел на документа**<a name="purpose"></a>
...
2.  **Текущо състояние**<a name="status-quo"></a>
...
3.  **Предложени решения**<a name="proposals"></a>
...
6.  **Често задавани въпроси**<a name="faq"></a>
