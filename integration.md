...
5.  **Електронна идентификация и журнал на действията от страна на АИС**
...
6.  **Допълнителни изисквания към първичните регистри**
...
7.  **Описание на централния координатор**
...
8.  **Описание на централния регистър**
