...
### 4. **Електронна идентификация и журнал на действията от страна на АИС**
...
### 5. **Допълнителни изисквания към първичните регистри**
...
### 6. **Описание на централния координатор**
...
-   да запише информация за заявката в журнал, използвайки сигурно
	време, предоставено от Time Stamping Authority, така
...
### 7. **Описание на централния регистър**
