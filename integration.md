...
2. [Сигнализиране за грешки](#error-reporting)
3. [Диаграма на действията](#flow)
4. [Електронна идентификация и журнал на действията от страна на АИС](#eid)
5. [Допълнителни изисквания към първичните регистри](#primary-registers)
6. [Описание на централния координатор](#coordinator)
7. [Описание на централния регистър](#cenetral-register)
...
5.  **Електронна идентификация и журнал на действията от страна на АИС**<a name="eid"></a>
...
6.  **Допълнителни изисквания към първичните регистри**<a name="primary-registers"></a>
...
7.  **Описание на централния координатор**<a name="coordinator"></a>
...
8.  **Описание на централния регистър**<a name="central-register"></a>
